...
/**
 * Check if current time is within the quiz window (3:32 PM - 3:34 PM)
...
export const getQuizWindowStatus = () => {
  ...
  const quizStartHour = 16;
  const quizStartMinute = 15;
  ...
  if (!isQuizWindow) {
    return {
      isQuizWindow: false,
      timeRemaining: 0,
      message: 'Quiz window is not active. Available: 3:32 PM - 3:34 PM',
    };
  }
